...
class FoodRatings {
    ...
    public FoodRatings(String[] foods, String[] cuisines, int[] ratings) {
        for (int i = 0; i < foods.length; i++) {
            ...
            sortedCuisine.computeIfAbsent(cuisine, k -> new TreeSet<>(Comparator.<Pair<Integer, String>, Integer>comparing(Pair::getKey).reversed().thenComparing(Pair::getValue))).add(new Pair<>(rating, food));
        }
    }
